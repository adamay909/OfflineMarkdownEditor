        ...
        function (e, t, n) {
          ...
          function h(e, t, n, i) {
            ...
            for (var a = 0; a < e.children.length; a++) {
              var l,
                s = e.children[a];
              ((l = f(
                "string" == typeof s && s in ne ? ne[s] : s,
                !0,
                t,
                n,
                "button",
          ...
          function P(e, t) {
            ...
            if (
              ...
              G(n, i.image, r.insertTexts.uploadedImage, t);
            else {
          ...
          function $(e) {
            ...
            o.classList.contains("editor-preview-active")
			  ...
			  //wr.classList.add("preview-container");
			  //o.appendChild(wr);
            ...
            if (
              ...
              if (!d.includes(h)) {
                ...
                /^\s*- \[[ xX]]\s/.test(f)
                  ...
                  : /^\s*\d+\.\s/.test(f)
                    ? (h = "ordered-list")
                    : /^\s*[*\-+]\s/.test(f) && (h = "unordered-list");
              }
              for (var p = a.line; p <= l.line; p++)
                !(function (n) {
                  var i = e.getLine(n);
                  (o[t]
                    ? (i = i.replace(s[t], "$1"))
                    : d.includes(h) && d.includes(t)
                      ? ((i = i.replace(s[h], "$1")),
                        (i = u(t, i, !1)),
                        (c += 1))
                      : ((i = u(t, i, !1)), (c += 1)),
          ...
          var te = {
            ...
            re = { link: "URL for the link:", image: "URL of the image:" },
            oe = {
              locale: "en-US",
          ...
          function ue(e) {
            ...
            if (void 0 === e.toolbar)
              for (var o in ((e.toolbar = []), ne))
                Object.prototype.hasOwnProperty.call(ne, o) &&
            ...
            if (
              ...
              (e.insertTexts = J({}, ie, e.insertTexts || {})),
              (e.promptTexts = J({}, re, e.promptTexts || {})),
              (e.blockStyles = J({}, ae, e.blockStyles || {})),
              null != e.autosave &&
                (e.autosave.timeFormat = J(
                  {},
                  oe,
                  e.autosave.timeFormat || {},
                )),
              (e.iconClassMap = J({}, te, e.iconClassMap || {})),
              ...
              (e.imageTexts = J({}, le, e.imageTexts || {})),
              (e.errorMessages = J({}, se, e.errorMessages || {})),
          ...
          ((ue.prototype.uploadImages = function (e, t, n) {
            ...
            (ue.prototype.uploadImage = function (e, t, n) {
              ...
              function o(t) {
                ...
                return t
                  ...
                  .replace("#image_size#", Y(e.size, n))
                  .replace("#image_max_size#", Y(i.options.imageMaxSize, n));
              }
              if (
                ((t =
                  t ||
                ...
                function (e) {
                  var i = (function (e) {
                    ...
                    return e
                      ...
                      .replace("#image_size#", Y(t.size, i))
                      .replace(
                        "#image_max_size#",
                        Y(n.options.imageMaxSize, i),
                      );
                  })(e);
            ...
            (ue.toggleBold = x),
            (ue.toggleItalic = y),
            (ue.toggleStrikethrough = b),
            (ue.toggleBlockquote = C),
            (ue.toggleHeadingSmaller = w),
            (ue.toggleHeadingBigger = k),
            (ue.toggleHeading1 = S),
            (ue.toggleHeading2 = F),
            (ue.toggleHeading3 = A),
            (ue.toggleHeading4 = E),
            (ue.toggleHeading5 = L),
            (ue.toggleHeading6 = T),
            (ue.toggleCodeBlock = D),
            (ue.toggleUnorderedList = M),
            (ue.toggleOrderedList = B),
            (ue.toggleCheckList = N),
            (ue.cleanBlock = O),
            (ue.drawLink = I),
            (ue.drawImage = z),
            (ue.drawUploadedImage = R),
            (ue.drawTable = _),
            (ue.drawHorizontalRule = W),
            (ue.undo = j),
            (ue.redo = q),
            (ue.togglePreview = $),
            (ue.toggleSideBySide = U),
            (ue.toggleFullScreen = v),
            (ue.prototype.toggleBold = function () {
              x(this);
            }),
